            ...
            <div className='grid grid-cols-3 md:grid-cols-5 gap-6 mt-3'>
                {CoachingExpert.map((expert,index)=>(
                    ...
                    <Image src={expert.avatar} alt='expert.name'
                      width={100} height={100} className={`${selectedExpert==expert.name&&'border-2'} rounded-2xl h-[80px] w-[80px] object-cover hover:scale-105 transition-all cursor-pointer p-1 border-pink-200`}/>
